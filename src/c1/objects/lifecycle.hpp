...
class ObjectDeletionHost {
public:
    virtual ~ObjectDeletionHost() = default;
    ...
    // These calls retain the native selected-creature refresh ordering while
    // keeping MFC windows, OLE kit notifications, and HWND invalidation out
    // of the clean object module.
    virtual bool selected_creature_exists() const = 0;
    virtual void clear_selected_creature() = 0;
    virtual void broadcast_embedded_control_state(std::uint32_t state) = 0;
    virtual void update_main_window_title() = 0;
    virtual void close_invalid_eye_view_or_refresh_title() = 0;
    virtual void return_viewport_navigation_to_selected_creature() = 0;
    virtual void refresh_event_bar_display_panes() = 0;
    ...
    virtual void delete_object(Object& object, bool record_auxiliary_state) = 0;
};
