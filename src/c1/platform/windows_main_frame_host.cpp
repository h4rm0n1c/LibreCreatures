...
BEGIN_MESSAGE_MAP(C1MainFrame, CFrameWnd)
    ...
    ON_WM_DESTROY()
    ON_WM_CLOSE()
    ON_COMMAND(0xe800, OnViewToolbar)
    ON_UPDATE_COMMAND_UI(0xe800, OnUpdateViewToolbar)
    ON_COMMAND(0xe801, OnViewStatusBar)
    ON_UPDATE_COMMAND_UI(0xe801, OnUpdateViewStatusBar)
    ON_COMMAND(107, OnTipOfDay)
    ...
    ON_COMMAND_RANGE(32808, 32823, OnToggleDebugLogCategory)
    ON_UPDATE_COMMAND_UI_RANGE(32808, 32823, OnUpdateToggleDebugLogCategory)
    ON_COMMAND(32870, OnToggleDebugLogging)
    ON_UPDATE_COMMAND_UI(32870, OnUpdateToggleDebugLogging)
    ON_COMMAND(32786, OnToggleCreaturesBurble)
    ON_UPDATE_COMMAND_UI(32786, OnUpdateToggleCreaturesBurble)
    ON_COMMAND(32840, OnEuthanasia)
    ON_COMMAND(32865, OnForceAgeing)
    ON_UPDATE_COMMAND_UI(32865, OnUpdateForceAgeing)
    ON_COMMAND(32807, OnInfectCurrentNorn)
    ON_COMMAND(32864, OnImportCreature)
    ON_COMMAND(32863, OnExportCurrentCreature)
    ON_UPDATE_COMMAND_UI(32863, OnUpdateExportCurrentCreature)
    ON_COMMAND(32804, OnCreateMaleNorn)
    ON_COMMAND(32805, OnCreateFemaleNorn)
    ON_COMMAND(32897, OnMuteCreatureVoices)
    ON_UPDATE_COMMAND_UI(32897, OnUpdateMuteCreatureVoices)
    ON_COMMAND(32839, OnAddFavouritePlace)
    ON_COMMAND(32867, OnRemoveFavouritePlace)
    ON_COMMAND(32896, OnShowCaosConsole)
    ON_UPDATE_COMMAND_UI(32896, OnUpdateShowCaosConsole)
    ON_COMMAND(32869, OnShowDebugConsole)
    ON_UPDATE_COMMAND_UI(32869, OnUpdateShowDebugConsole)
    ON_COMMAND(32771, OnToggleEyeView)
    ON_UPDATE_COMMAND_UI(32771, OnUpdateToggleEyeView)
    ON_COMMAND(32777, OnInstantVerbVocabulary)
    ...
    ON_COMMAND(32774, OnInfiniteWorld)
    ON_UPDATE_COMMAND_UI(32774, OnUpdateInfiniteWorld)
    ON_COMMAND(32866, OnSmoothScrolling)
    ON_UPDATE_COMMAND_UI(32866, OnUpdateSmoothScrolling)
    ON_COMMAND(32891, OnMuteSounds)
    ON_COMMAND(32892, OnInformativeCreaturesMenu)
    ON_UPDATE_COMMAND_UI(32891, OnUpdateMuteSounds)
    ON_UPDATE_COMMAND_UI(32892, OnUpdateInformativeCreaturesMenu)
    ON_COMMAND(32894, OnVolume)
    ON_COMMAND(32832, OnWebConnect)
    ON_COMMAND(57664, OnAbout)
    ON_WM_TIMER()
